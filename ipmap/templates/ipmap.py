...
__CHEETAH_genTime__ = 1470161095.6969709
__CHEETAH_genTimestamp__ = 'Tue Aug  2 20:04:55 2016'
__CHEETAH_src__ = 'ipmap/templates/ipmap.tmpl'
__CHEETAH_srcLastModified__ = 'Tue Aug  2 19:05:46 2016'
...
''')
        m = VFFSL(SL,"len",False)(VFFSL(SL,"country_codes",True))
        j = 0
        write(u'''
     <div id = "marker_list" style = "display : none;">   
''')
        for el in VFFSL(SL,"alert_list",True)	: # generated from line 10, col 9
            if VFFSL(SL,"el",True)[3]: # generated from line 11, col 4
                _v = VFFSL(SL,"el",True)[3] # u'$el[3]' on line 12, col 1
                if _v is not None: write(_filter(_v, rawExpr=u'$el[3]')) # from line 12, col 1.
                write(u''', ''')
                _v = VFFSL(SL,"el",True)[4] # u'$el[4]' on line 12, col 9
                if _v is not None: write(_filter(_v, rawExpr=u'$el[4]')) # from line 12, col 9.
                write(u'''?''')
                _v = VFFSL(SL,"el",True)[1] # u'$el[1]' on line 12, col 16
                if _v is not None: write(_filter(_v, rawExpr=u'$el[1]')) # from line 12, col 16.
                write(u'''?''')
                _v = VFFSL(SL,"el",True)[7] # u'$el[7]' on line 12, col 23
                if _v is not None: write(_filter(_v, rawExpr=u'$el[7]')) # from line 12, col 23.
                write(u'''?''')
                _v = VFFSL(SL,"el",True)[0] # u'$el[0]' on line 12, col 30
                if _v is not None: write(_filter(_v, rawExpr=u'$el[0]')) # from line 12, col 30.
                write(u'''!
''')
        write(u'''     </div>
...
''')
        for el in VFFSL(SL,"country_codes",True): # generated from line 18, col 1
            _v = VFFSL(SL,"el",True) # u'$el' on line 19, col 1
            if _v is not None: write(_filter(_v, rawExpr=u'$el')) # from line 19, col 1.
            write(u''',
''')
        write(u'''     </div>
...
''')
        while VFFSL(SL,"j",True) < VFFSL(SL,"m",True): # generated from line 36, col 8
            write(u'''\t\t\t    <button id="''')
            _v = VFFSL(SL,"country_codes",True)[VFFSL(SL,"j",True)] # u'$country_codes[$j]' on line 37, col 20
            if _v is not None: write(_filter(_v, rawExpr=u'$country_codes[$j]')) # from line 37, col 20.
            write(u'''" class = "tri">''')
            _v = VFFSL(SL,"country_list",True)[VFFSL(SL,"j",True)] # u'$country_list[$j]' on line 37, col 54
            if _v is not None: write(_filter(_v, rawExpr=u'$country_list[$j]')) # from line 37, col 54.
            write(u'''</button>
''')
            j = VFFSL(SL,"j",True) + 1
        write(u'''\t\t       </div>
...
''')
        for el in VFFSL(SL,"alert_list",True): # generated from line 44, col 15
            if VFFSL(SL,"el",True)[3]: # generated from line 45, col 11
                write(u'''\t\t\t\t      <div id = "''')
                _v = VFFSL(SL,"j",True) # u'$j' on line 46, col 22
                if _v is not None: write(_filter(_v, rawExpr=u'$j')) # from line 46, col 22.
                write(u'''" class = "alert_data ''')
                _v = VFFSL(SL,"el",True)[2] # u'$el[2]' on line 46, col 46
                if _v is not None: write(_filter(_v, rawExpr=u'$el[2]')) # from line 46, col 46.
                write(u''' ''')
                _v = VFFSL(SL,"el",True)[6] # u'$el[6]' on line 46, col 53
                if _v is not None: write(_filter(_v, rawExpr=u'$el[6]')) # from line 46, col 53.
                write(u'''"> 
\t\t\t\t      \t   ''')
                _v = VFFSL(SL,"el",True)[1] # u'$el[1]' on line 47, col 15
                if _v is not None: write(_filter(_v, rawExpr=u'$el[1]')) # from line 47, col 15.
                write(u'''</br>
\t\t\t\t      \t   Source : ''')
                _v = VFFSL(SL,"el",True)[0] # u'$el[0]' on line 48, col 24
                if _v is not None: write(_filter(_v, rawExpr=u'$el[0]')) # from line 48, col 24.
                write(u'''</br>
\t\t\t\t      \t   Location : ''')
                _v = VFFSL(SL,"el",True)[5] # u'$el[5]' on line 49, col 26
                if _v is not None: write(_filter(_v, rawExpr=u'$el[5]')) # from line 49, col 26.
                write(u'''
\t\t\t\t      </div>
''')
            j += 1
...
''')
        _filter = self._CHEETAH__currentFilter = _orig_filter_27357070
